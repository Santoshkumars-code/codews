    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <Divider />
         ...
         <Button component={Link} to="/admin" sx={{ my: 2, color: 'white', display: 'block' }}>Home</Button>
         <Button component={Link} to="/managestudent" sx={{ my: 2, color: 'white', display: 'block' }}>Manage Student</Button>
         <Button component={Link} to="/managefee" sx={{ my: 2, color: 'white', display: 'block' }}>Manage Student</Button>
         <Button component={Link} to="/courses" sx={{ my: 2, color: 'white', display: 'block' }}>Manage Courses</Button>
         ...
         <Button component={Link} to="/login" sx={{ my: 2, color: 'white', display: 'block' }}>Logout</Button>
          {/* {['Home', 'Manage Student', 'Manage Courses','Manage Fee', 'Placement'].map((text, index) => (
