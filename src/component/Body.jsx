    ...
    <>
      ...
      <div className="container">
        <div className="col-lg-12">
          <div className="row">
      <h3 className='cours'>Courses</h3>
      {
                  data.map((item , i)=>{
                     {console.log(item.isVerified)}

             return <div className="col-md-6 col-lg-2 mt-2" key={i}>
              ...
              <div className="card" >
               ...
               <div className='card-footer durationtext'>Duration: <span className='text-muted'>{item.duration}</span></div>
               </div>            
          </div>
            })
          }
